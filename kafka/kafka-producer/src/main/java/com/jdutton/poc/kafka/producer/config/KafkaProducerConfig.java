package com.jdutton.poc.kafka.producer.config;
...
import com.jdutton.poc.config.KafkaProducerConfigData;
...
public class KafkaProducerConfig <K extends Serializable, V extends SpecificRecordBase>{
	...
	public Map<String, Object> producerConfig() {
		...
		props.put(ProducerConfig.REQUEST_TIMEOUT_MS_CONFIG, kafkaProducerConfigData.getRequestTimetoutMs());
